...
author: "STUDENT NAME -V5 template fixed (REPLACE WITH YOUR NAME HERE)"
...
library(dplyr) 
library(tidyverse) 
library(haven) # read multiple format of datasets
library(ggplot2) # plots
library(formatR) 
library(psych) # for summary stats and others
library(kableExtra) # For tables
library(BSDA) # for stats tests
```
...
Complete the code for the standard DEVIATION and interpret the results. Also, using the p-value determine if you can reject the null hypothesis at the 5% or 1% significance level.
...
SD_null_hypot <- 'Replace with the formula for the standard DEVIATION'

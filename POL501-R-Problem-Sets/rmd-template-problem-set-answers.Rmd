...
author: "Solutions"
date: "`r Sys.Date()`"  # Automatically sets the current date
output: 
  pdf_document:
...
social_trust_index <- c(21.48, 48.90, 76.20, 96.73, 96.87, 98.58, 102.14, 85.35, 59.21, 37.10, 1.20)
...
**Interpretation:**
   ...
   - Social Trust Level:
     - The mean (65.48) and median (76.2) indicate a skewed distribution, likely left-skewed because the mean is less than the median.
     - The high standard deviation (33.80) indicates high variability in social trust levels among the neighborhoods.
...
bin_breaks_activities <- seq(min_activities, max_activities, length.out = 6)  # 5 bins require 6 boundaries
